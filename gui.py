...
def amsg(
    ...
    messageVar.pack()
    submit = Button(main, text='Copy Hash', padx=10, pady=10,
                    command=paste)
    submit.pack()
    quitButton(main)
    main.mainloop()
...
def cvote(candidate):
    ...
    heading = Label(re, text=ms, bg='light blue',
...
def start():
    heading = Label(re, text='ENTER CLIENT DETAILS', bg='light blue',
                    pady='10', font=('TIMES NEW ROMAN', 30))
    name = Label(re, text='Client Number', bg='light blue',
                 font=('TIMES NEW ROMAN', 15))
    i = Label(re, text='IP OF SERVER', bg='light blue',
              font=('TIMES NEW ROMAN', 15))
...
def top():
    heading = Label(re, text='VOTER ACTIONS', bg='light blue', pady='10'
...
def home():
    ...
    head = Label(re, text=ms, bg='light blue', font=('TIMES NEW ROMAN',
                 15))
    head.grid(row=5, column=1)
...
def avoter():
    clear()
    top()
    heading = Label(re, text='ADD A VOTER', bg='light blue', pady='10',
                    font=('TIMES NEW ROMAN', 30))
...
def avote():
    ...
    heading = Label(re, text='ADD A VOTE', bg='light blue', pady='10',
                    font=('TIMES NEW ROMAN', 30))
...
def countvote():
    clear()
    top()
    heading = Label(re, text='COUNT VOTE', bg='light blue', pady='10',
                    font=('TIMES NEW ROMAN', 30))
...
def icheck():
    ...
    heading.grid(row=5, column=1)
    head = Label(re, text=message, bg='light Blue',
                 font=('TIMES NEW ROMAN', 15))
    head.grid(row=5, column=1)
    button = tk.Button(
        re,
